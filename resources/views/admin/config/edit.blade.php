            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span><i class="fa fa-exclamation-circle yellow"></i>这里是配置项标题必须填写</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <span><i class="fa fa-exclamation-circle yellow"></i>这里是配置项名称必须填写</span>
                    </td>
                </tr>
                <tr>
                    <th>类型：</th>
                ...
                <tr class="field_value" style="display: none">
                    ...
                    <td>
                        ...
                        <p><i class="fa fa-exclamation-circle yellow"></i>类型值只有在radio才需要配置，格式 1|开启,0|关闭</p>

...
//                                        给input标签填充图片地址
                ...
                <tr>
                    <th></th>
                    <td>
                        <img style="max-width: 350px;max-height: 100px;" id="art_thumb_img" alt=""
                             src="/{{$field ->art_thumb}}">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <script type="text/javascript" charset="utf-8"
                                src="{{url(asset('resources/org/ueditor/ueditor.config.js'))}}"></script>
                        <script type="text/javascript" charset="utf-8"
                                src="{{url(asset('resources/org/ueditor/ueditor.all.min.js'))}}"></script>
                        <script type="text/javascript" charset="utf-8"
                                src="{{url(asset('resources/org/ueditor/lang/zh-cn/zh-cn.js'))}}"></script>
                        <script id="editor" name="art_content" type="text/plain" style="width:860px;height:300px;">
                            {!! $field ->art_content !!}
                        </script>
                        <script type="text/javascript">

...
@section('content')
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>个人网站：</label><span><a href="http://www.joker1996.com" target="_blank">http://www.joker1996.com</a></span>
                </li>
                <li>
                    <label>个人论坛：</label><span><a href="http://utopia.joker1996.com" target="_blank">http://utopia.joker1996.com</a></span>
                </li>
                <li>
                    <label>交流QQ：</label><span>1090035743</span>
                </li>
                <li>
                    <label>联系邮箱：</label><span>1090035743@qq.com</span>
                </li>
            </ul>
        </div>
    </div>
